...
| --- | --- | --- | --- |
| `rfc3552` | [RFC 3552](https://www.rfc-editor.org/rfc/rfc3552.html), BCP 72 (July 2003) | 2, 2.1–2.3, 3, 3.1–3.5, 4.6, 5 | Communication-security goals; explicit threat-model scope; passive/active network operations; denial of service. |
| `nist-sp-800-57pt1r5` | [NIST SP 800-57 Part 1 Rev. 5](https://doi.org/10.6028/NIST.SP.800-57pt1r5) (May 2020) | 3, 4.4, 5–5.6.4, 6.2, 7, 8–8.4, 9.5 | Key use and separation, metadata protection, compromise, lifecycle states, change, recovery, revocation, and destruction terminology. |
| `nist-sp-800-30r1` | [NIST SP 800-30 Rev. 1](https://doi.org/10.6028/NIST.SP.800-30r1) (September 2012) | 2.3, 3.2 Tasks 2-1 through 2-3, 3.3, Appendices D–F | Separation of threat sources, capabilities, threat events, vulnerabilities, preconditions, and impacts. CCA-120 intentionally omits likelihood and risk scoring. |
...
| `rfc9420` | [RFC 9420](https://www.rfc-editor.org/rfc/rfc9420.html) (July 2023) | 14–16, especially 16.4, 16.6–16.10, and 16.12 | Example of state sequencing, metadata exposure, forward secrecy, post-compromise recovery, key reuse, and service-compromise assumptions. MLS is not selected or required. |
